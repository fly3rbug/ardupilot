...
/*
 * control_freeforwardflight.pde - init and run calls for new flight mode
 */

// freeforwardflight_init - initialise flight mode
static bool freeforwardflight_init(bool ignore_checks)
{
...
// freeforwardflight_run - runs the main controller
// will be called at 100hz or more
static void freeforwardflight_run()
{
