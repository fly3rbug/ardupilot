...
/*
 * control_stabilizedforwardflight.pde - init and run calls for new flight mode
 */

// stabilizedforwardflight_init - initialise flight mode
static bool stabilizedforwardflight_init(bool ignore_checks)
{
...
// stabilizedforwardflight_run - runs the main controller
// will be called at 100hz or more
static void stabilizedforwardflight_run()
{
